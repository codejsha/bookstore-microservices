...
variable "opensearch_dashboards_address" {
  description = "OpenSearch Dashboards address"
  type        = string
}

variable "opensearch_dashboards_service_name" {
  description = "OpenSearch Dashboards in-cluster Service name"
  type        = string
}
