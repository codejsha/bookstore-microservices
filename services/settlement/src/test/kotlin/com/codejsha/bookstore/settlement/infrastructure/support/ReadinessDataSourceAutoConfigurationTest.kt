...
class ReadinessDataSourceAutoConfigurationTest {
    ...
    private val contextRunner =
        ApplicationContextRunner()
            ...
            .withPropertyValues(
                ...
                "spring.datasource.url=jdbc:mysql://localhost:3306/settlement_db",
    ...
    fun `context_vaultWatchersRegistered_rotatesBothPools`() {
        contextRunner
            .withBean("paymentDataSource", HikariDataSource::class.java, { HikariDataSource() })
            .withUserConfiguration(VaultCredentialConfig::class.java)
            .run { context ->
