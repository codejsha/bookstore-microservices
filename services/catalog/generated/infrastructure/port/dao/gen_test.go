...
func Test_WithContext(t *testing.T) {
	...
	for _, ctx := range []context.Context{
		qCtx.AuthorEntity.UnderlyingDB().Statement.Context,
		qCtx.EditionEntity.UnderlyingDB().Statement.Context,
		qCtx.PublisherEntity.UnderlyingDB().Statement.Context,
		qCtx.SubjectEntity.UnderlyingDB().Statement.Context,
		qCtx.WorkAuthorMappingEntity.UnderlyingDB().Statement.Context,
		qCtx.WorkEntity.UnderlyingDB().Statement.Context,
		qCtx.WorkSubjectMappingEntity.UnderlyingDB().Statement.Context,
	} {
