module github.com/codejsha/bookstore-microservices/catalog

go 1.23

require (
	github.com/codejsha/bookstore-microservices/commonlib-go v0.0.1
...
require (
	...
	github.com/conductor-sdk/conductor-go v1.5.1 // indirect
