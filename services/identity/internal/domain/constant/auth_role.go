...
const (
	...
	AUTHROLE_ADMIN_VALUE   AuthRoleValue = "ADMIN"
)
...
func (a AuthRole) ToAuthRoleProto() string {
	switch a {
	case AUTHROLE_ADMIN:
		return string(AUTHROLE_ADMIN_VALUE)
	case AUTHROLE_SYSTEM:
		return string(AUTHROLE_SYSTEM_VALUE)
	case AUTHROLE_MANAGE:
		return string(AUTHROLE_MANAGE_VALUE)
	case AUTHROLE_PROFILE:
		return string(AUTHROLE_PROFILE_VALUE)
	case AUTHROLE_ORDER:
		return string(AUTHROLE_ORDER_VALUE)
	case AUTHROLE_VIEW:
		return string(AUTHROLE_VIEW_VALUE)
	default:
...
func AuthRoleFromString(value string) AuthRole {
	...
	case string(AUTHROLE_ADMIN_VALUE):
		return AUTHROLE_ADMIN
