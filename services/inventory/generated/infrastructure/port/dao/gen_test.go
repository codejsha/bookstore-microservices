...
func Test_WithContext(t *testing.T) {
	...
	for _, ctx := range []context.Context{
		qCtx.MonthlyClosingEntity.UnderlyingDB().Statement.Context,
		qCtx.MonthlyClosingItemEntity.UnderlyingDB().Statement.Context,
		qCtx.StockAuditEntity.UnderlyingDB().Statement.Context,
		qCtx.StockAuditItemEntity.UnderlyingDB().Statement.Context,
		qCtx.StockEntity.UnderlyingDB().Statement.Context,
		qCtx.StockHistoryEntity.UnderlyingDB().Statement.Context,
		qCtx.StockReservationEntity.UnderlyingDB().Statement.Context,
		qCtx.StockTransferEntity.UnderlyingDB().Statement.Context,
		qCtx.WarehouseEntity.UnderlyingDB().Statement.Context,
	} {
