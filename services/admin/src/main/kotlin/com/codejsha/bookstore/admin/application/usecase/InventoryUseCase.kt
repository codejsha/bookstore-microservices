...
interface InventoryUseCase {
    fun findAllWarehouses(name: String?, pageable: Pageable, context: ActorContext): Page<Warehouse>

    fun findWarehouse(uid: String, context: ActorContext): Warehouse

    fun findAllStocks(option: StockQueryOption, pageable: Pageable, context: ActorContext): Page<Stock>
}
