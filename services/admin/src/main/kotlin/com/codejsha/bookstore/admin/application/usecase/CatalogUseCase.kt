...
interface CatalogUseCase {
    fun findAllWorks(option: WorkQueryOption, pageable: Pageable, context: ActorContext): Page<Work>

    fun findWork(uid: String, context: ActorContext): Work

    fun createWork(command: WorkCreateCommand, context: ActorContext)

    fun updateWork(uid: String, command: WorkUpdateCommand, context: ActorContext): Work

    fun findAllAuthors(name: String?, pageable: Pageable, context: ActorContext): Page<Author>

    fun findAllSubjects(name: String?, pageable: Pageable, context: ActorContext): Page<Subject>
}
