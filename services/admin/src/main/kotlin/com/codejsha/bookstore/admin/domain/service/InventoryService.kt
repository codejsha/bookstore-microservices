...
class InventoryService(
    ...
    override fun findAllWarehouses(name: String?, pageable: Pageable, context: ActorContext) =
        inventoryClient.findAllWarehouses(name, pageable)

    override fun findWarehouse(uid: String, context: ActorContext) = inventoryClient.findWarehouse(uid)

    override fun findAllStocks(option: StockQueryOption, pageable: Pageable, context: ActorContext) =
