...
public final class AuthorServiceGrpc {
    ...
    @io.grpc.stub.annotations.RpcMethod(
            ...
            requestType = com.codejsha.bookstore.service.application.port.pb.authorpb.AuthorFindAllProtoReq.class,
            responseType = com.codejsha.bookstore.service.application.port.pb.authorpb.AuthorFindAllProtoResp.class,
    ...
    public static io.grpc.MethodDescriptor<
        ...
        if ((getFindAllAuthorsMethod = AuthorServiceGrpc.getFindAllAuthorsMethod) == null) {
            synchronized (AuthorServiceGrpc.class) {
                if ((getFindAllAuthorsMethod = AuthorServiceGrpc.getFindAllAuthorsMethod) == null) {
                    AuthorServiceGrpc.getFindAllAuthorsMethod = getFindAllAuthorsMethod = io.grpc.MethodDescriptor
                            .<com.codejsha.bookstore.service.application.port.pb.authorpb.AuthorFindAllProtoReq,
                                    com.codejsha.bookstore.service.application.port.pb.authorpb.AuthorFindAllProtoResp>
                                    newBuilder()
                            ...
                            .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(com.codejsha.bookstore.service
                                    .application.port.pb.authorpb.AuthorFindAllProtoReq.getDefaultInstance()))
                            .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(com.codejsha.bookstore.service
                                    .application.port.pb.authorpb.AuthorFindAllProtoResp.getDefaultInstance()))
                            .setSchemaDescriptor(new AuthorServiceMethodDescriptorSupplier("FindAllAuthors"))
                            .build();
                }
            }
        }
    ...
    @io.grpc.stub.annotations.RpcMethod(
            ...
            requestType = com.codejsha.bookstore.service.application.port.pb.authorpb.AuthorFindProtoReq.class,
            responseType = com.codejsha.bookstore.service.application.port.pb.authorpb.AuthorFindProtoResp.class,
            methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
    public static io.grpc.MethodDescriptor<
                    com.codejsha.bookstore.service.application.port.pb.authorpb.AuthorFindProtoReq,
                    com.codejsha.bookstore.service.application.port.pb.authorpb.AuthorFindProtoResp>
        ...
        if ((getFindAuthorMethod = AuthorServiceGrpc.getFindAuthorMethod) == null) {
            synchronized (AuthorServiceGrpc.class) {
                if ((getFindAuthorMethod = AuthorServiceGrpc.getFindAuthorMethod) == null) {
                    AuthorServiceGrpc.getFindAuthorMethod = getFindAuthorMethod = io.grpc.MethodDescriptor
                            .<com.codejsha.bookstore.service.application.port.pb.authorpb.AuthorFindProtoReq,
                                    com.codejsha.bookstore.service.application.port.pb.authorpb.AuthorFindProtoResp>
                                    newBuilder()
                            .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
                            ...
                            .setSampledToLocalTracing(true)
                            .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(com.codejsha.bookstore.service
                                    .application.port.pb.authorpb.AuthorFindProtoReq.getDefaultInstance()))
                            .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(com.codejsha.bookstore.service
                                    .application.port.pb.authorpb.AuthorFindProtoResp.getDefaultInstance()))
    ...
    public interface AsyncService {
        ...
        default void findAllAuthors(
                ...
                io.grpc.stub.StreamObserver<
                                com.codejsha.bookstore.service.application.port.pb.authorpb.AuthorFindAllProtoResp>
                        responseObserver) {
            io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getFindAllAuthorsMethod(), responseObserver);
        }
     ...
     */
    public abstract static class AuthorServiceImplBase implements io.grpc.BindableService, AsyncService {
     ...
     */
    public static final class AuthorServiceStub extends io.grpc.stub.AbstractAsyncStub<AuthorServiceStub> {
        ...
        public void findAllAuthors(
            ...
            io.grpc.stub.ClientCalls.asyncUnaryCall(
                    getChannel().newCall(getFindAllAuthorsMethod(), getCallOptions()), request, responseObserver);
        }
    ...
    public static final class AuthorServiceBlockingV2Stub
        ...
        @java.lang.Override
        protected AuthorServiceBlockingV2Stub build(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
            return new AuthorServiceBlockingV2Stub(channel, callOptions);
        }
         ...
         *
         */
        public com.codejsha.bookstore.service.application.port.pb.authorpb.AuthorFindAllProtoResp findAllAuthors(
                com.codejsha.bookstore.service.application.port.pb.authorpb.AuthorFindAllProtoReq request) {
         ...
         *
         */
        public com.codejsha.bookstore.service.application.port.pb.authorpb.AuthorFindProtoResp findAuthor(
                com.codejsha.bookstore.service.application.port.pb.authorpb.AuthorFindProtoReq request) {
            return io.grpc.stub.ClientCalls.blockingUnaryCall(
    ...
    public static final class AuthorServiceBlockingStub
        ...
        @java.lang.Override
        protected AuthorServiceBlockingStub build(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
            return new AuthorServiceBlockingStub(channel, callOptions);
        }
     ...
     */
    public static final class AuthorServiceFutureStub extends io.grpc.stub.AbstractFutureStub<AuthorServiceFutureStub> {
        private AuthorServiceFutureStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
            super(channel, callOptions);
        }

        @java.lang.Override
        protected AuthorServiceFutureStub build(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
            return new AuthorServiceFutureStub(channel, callOptions);
        }
        ...
        public com.google.common.util.concurrent.ListenableFuture<
                        com.codejsha.bookstore.service.application.port.pb.authorpb.AuthorFindProtoResp>
                findAuthor(com.codejsha.bookstore.service.application.port.pb.authorpb.AuthorFindProtoReq request) {
            return io.grpc.stub.ClientCalls.futureUnaryCall(
        ...
        return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
                .addMethod(
                        ...
                        io.grpc.stub.ServerCalls.asyncUnaryCall(new MethodHandlers<
                                com.codejsha.bookstore.service.application.port.pb.authorpb.AuthorFindAllProtoReq,
                                com.codejsha.bookstore.service.application.port.pb.authorpb.AuthorFindAllProtoResp>(
                                service, METHODID_FIND_ALL_AUTHORS)))
                .addMethod(
                        getFindAuthorMethod(),
                        io.grpc.stub.ServerCalls.asyncUnaryCall(new MethodHandlers<
                                com.codejsha.bookstore.service.application.port.pb.authorpb.AuthorFindProtoReq,
                                com.codejsha.bookstore.service.application.port.pb.authorpb.AuthorFindProtoResp>(
                                service, METHODID_FIND_AUTHOR)))
                .build();
    }
    ...
    private abstract static class AuthorServiceBaseDescriptorSupplier
        ...
        public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
            return com.codejsha.bookstore.service.application.port.pb.authorpb.AuthorProto.getDescriptor();
        }
    ...
    private static final class AuthorServiceFileDescriptorSupplier extends AuthorServiceBaseDescriptorSupplier {
        AuthorServiceFileDescriptorSupplier() {}
    }

    private static final class AuthorServiceMethodDescriptorSupplier extends AuthorServiceBaseDescriptorSupplier
