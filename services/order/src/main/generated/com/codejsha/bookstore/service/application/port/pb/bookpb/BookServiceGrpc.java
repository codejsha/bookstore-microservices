...
public final class BookServiceGrpc {
    ...
    @io.grpc.stub.annotations.RpcMethod(
            ...
            requestType = com.codejsha.bookstore.service.application.port.pb.bookpb.BookFindAllProtoReq.class,
            responseType = com.codejsha.bookstore.service.application.port.pb.bookpb.BookFindAllProtoResp.class,
    ...
    public static io.grpc.MethodDescriptor<
        ...
        if ((getFindAllBooksMethod = BookServiceGrpc.getFindAllBooksMethod) == null) {
            synchronized (BookServiceGrpc.class) {
                if ((getFindAllBooksMethod = BookServiceGrpc.getFindAllBooksMethod) == null) {
                    BookServiceGrpc.getFindAllBooksMethod = getFindAllBooksMethod = io.grpc.MethodDescriptor
                            .<com.codejsha.bookstore.service.application.port.pb.bookpb.BookFindAllProtoReq,
                                    com.codejsha.bookstore.service.application.port.pb.bookpb.BookFindAllProtoResp>
                                    newBuilder()
                            ...
                            .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(com.codejsha.bookstore.service
                                    .application.port.pb.bookpb.BookFindAllProtoReq.getDefaultInstance()))
                            .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(com.codejsha.bookstore.service
                                    .application.port.pb.bookpb.BookFindAllProtoResp.getDefaultInstance()))
    ...
    @io.grpc.stub.annotations.RpcMethod(
            ...
            requestType = com.codejsha.bookstore.service.application.port.pb.bookpb.BookFindProtoReq.class,
            responseType = com.codejsha.bookstore.service.application.port.pb.bookpb.BookFindProtoResp.class,
            methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
    public static io.grpc.MethodDescriptor<
                    com.codejsha.bookstore.service.application.port.pb.bookpb.BookFindProtoReq,
                    com.codejsha.bookstore.service.application.port.pb.bookpb.BookFindProtoResp>
        ...
        if ((getFindBookMethod = BookServiceGrpc.getFindBookMethod) == null) {
            synchronized (BookServiceGrpc.class) {
                if ((getFindBookMethod = BookServiceGrpc.getFindBookMethod) == null) {
                    BookServiceGrpc.getFindBookMethod = getFindBookMethod = io.grpc.MethodDescriptor
                            .<com.codejsha.bookstore.service.application.port.pb.bookpb.BookFindProtoReq,
                                    com.codejsha.bookstore.service.application.port.pb.bookpb.BookFindProtoResp>
                                    newBuilder()
                            .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
                            ...
                            .setSampledToLocalTracing(true)
                            .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(com.codejsha.bookstore.service
                                    .application.port.pb.bookpb.BookFindProtoReq.getDefaultInstance()))
                            .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(com.codejsha.bookstore.service
                                    .application.port.pb.bookpb.BookFindProtoResp.getDefaultInstance()))
    ...
    public interface AsyncService {
        ...
        default void findAllBooks(
                ...
                io.grpc.stub.StreamObserver<
                                com.codejsha.bookstore.service.application.port.pb.bookpb.BookFindAllProtoResp>
                        responseObserver) {
            io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getFindAllBooksMethod(), responseObserver);
        }
        ...
        default void findBook(
                ...
                io.grpc.stub.StreamObserver<com.codejsha.bookstore.service.application.port.pb.bookpb.BookFindProtoResp>
                        responseObserver) {
     ...
     */
    public abstract static class BookServiceImplBase implements io.grpc.BindableService, AsyncService {
    ...
    public static final class BookServiceBlockingV2Stub
        ...
        @java.lang.Override
        protected BookServiceBlockingV2Stub build(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
            return new BookServiceBlockingV2Stub(channel, callOptions);
        }
         ...
         *
         */
        public com.codejsha.bookstore.service.application.port.pb.bookpb.BookFindAllProtoResp findAllBooks(
                com.codejsha.bookstore.service.application.port.pb.bookpb.BookFindAllProtoReq request) {
    ...
    public static final class BookServiceBlockingStub
        ...
        @java.lang.Override
        protected BookServiceBlockingStub build(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
            return new BookServiceBlockingStub(channel, callOptions);
        }
    ...
    public static final class BookServiceFutureStub extends io.grpc.stub.AbstractFutureStub<BookServiceFutureStub> {
        ...
        @java.lang.Override
        protected BookServiceFutureStub build(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
            return new BookServiceFutureStub(channel, callOptions);
        }
        ...
        public com.google.common.util.concurrent.ListenableFuture<
                        com.codejsha.bookstore.service.application.port.pb.bookpb.BookFindAllProtoResp>
                findAllBooks(com.codejsha.bookstore.service.application.port.pb.bookpb.BookFindAllProtoReq request) {
        ...
        public com.google.common.util.concurrent.ListenableFuture<
                        com.codejsha.bookstore.service.application.port.pb.bookpb.BookFindProtoResp>
                findBook(com.codejsha.bookstore.service.application.port.pb.bookpb.BookFindProtoReq request) {
            return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    private static final class BookServiceFileDescriptorSupplier extends BookServiceBaseDescriptorSupplier {
        BookServiceFileDescriptorSupplier() {}
    }

    private static final class BookServiceMethodDescriptorSupplier extends BookServiceBaseDescriptorSupplier
