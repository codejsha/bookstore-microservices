...
interface OrderApi {
    ...
    fun apiV1OrdersGet(
        @Valid @RequestParam(value = "user_id", required = false) userId: kotlin.String?,
        @Valid @RequestParam(
            value = "sort",
            required = false,
        ...
        @Min(1) @Valid @RequestParam(
            value = "limit",
            required = false,
            defaultValue = "10"
        ) limit: kotlin.Int,
        @Min(0) @Valid @RequestParam(
            value = "offset",
            required = false,
            defaultValue = "0"
        ) offset: kotlin.Int
    ...
    fun apiV1OrdersIdGet(
        @PathVariable("id") id: kotlin.Long
    ): Mono<OrderFindWebResp>
    ...
    fun apiV1OrdersPost(
        @Valid @RequestBody orderCreateWebReq: OrderCreateWebReq
    ): Mono<Unit>
}
