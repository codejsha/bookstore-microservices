...
public final class CategoryServiceGrpc {
    ...
    @io.grpc.stub.annotations.RpcMethod(
            ...
            requestType = com.codejsha.bookstore.service.application.port.pb.categorypb.CategoryFindAllProtoReq.class,
            responseType = com.codejsha.bookstore.service.application.port.pb.categorypb.CategoryFindAllProtoResp.class,
    ...
    public static io.grpc.MethodDescriptor<
        ...
        if ((getFindAllCategoriesMethod = CategoryServiceGrpc.getFindAllCategoriesMethod) == null) {
            synchronized (CategoryServiceGrpc.class) {
                if ((getFindAllCategoriesMethod = CategoryServiceGrpc.getFindAllCategoriesMethod) == null) {
                    CategoryServiceGrpc.getFindAllCategoriesMethod = getFindAllCategoriesMethod = io.grpc
                            .MethodDescriptor
                            .<com.codejsha.bookstore.service.application.port.pb.categorypb.CategoryFindAllProtoReq,
                            ...
                            .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(com.codejsha.bookstore.service
                                    .application.port.pb.categorypb.CategoryFindAllProtoReq.getDefaultInstance()))
                            .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(com.codejsha.bookstore.service
                                    .application.port.pb.categorypb.CategoryFindAllProtoResp.getDefaultInstance()))
                            .setSchemaDescriptor(new CategoryServiceMethodDescriptorSupplier("FindAllCategories"))
                            .build();
                }
            }
        }
    ...
    public interface AsyncService {
        ...
        default void findAllCategories(
                com.codejsha.bookstore.service.application.port.pb.categorypb.CategoryFindAllProtoReq request,
                io.grpc.stub.StreamObserver<
                                com.codejsha.bookstore.service.application.port.pb.categorypb.CategoryFindAllProtoResp>
                        responseObserver) {
            io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getFindAllCategoriesMethod(), responseObserver);
        }
    }
     ...
     */
    public abstract static class CategoryServiceImplBase implements io.grpc.BindableService, AsyncService {
    ...
    public static final class CategoryServiceStub extends io.grpc.stub.AbstractAsyncStub<CategoryServiceStub> {
        ...
        public void findAllCategories(
            ...
            io.grpc.stub.ClientCalls.asyncUnaryCall(
                    getChannel().newCall(getFindAllCategoriesMethod(), getCallOptions()), request, responseObserver);
        }
    }
    ...
    public static final class CategoryServiceBlockingV2Stub
        ...
        private CategoryServiceBlockingV2Stub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
            super(channel, callOptions);
        }

        @java.lang.Override
        protected CategoryServiceBlockingV2Stub build(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
            return new CategoryServiceBlockingV2Stub(channel, callOptions);
        }
         ...
         *
         */
        public com.codejsha.bookstore.service.application.port.pb.categorypb.CategoryFindAllProtoResp findAllCategories(
                com.codejsha.bookstore.service.application.port.pb.categorypb.CategoryFindAllProtoReq request) {
    ...
    public static final class CategoryServiceBlockingStub
        ...
        @java.lang.Override
        protected CategoryServiceBlockingStub build(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
            return new CategoryServiceBlockingStub(channel, callOptions);
        }
    ...
    public static final class CategoryServiceFutureStub
        ...
        @java.lang.Override
        protected CategoryServiceFutureStub build(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
            return new CategoryServiceFutureStub(channel, callOptions);
        }
        ...
        return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
                .addMethod(
                        ...
                        io.grpc.stub.ServerCalls.asyncUnaryCall(new MethodHandlers<
                                com.codejsha.bookstore.service.application.port.pb.categorypb.CategoryFindAllProtoReq,
                                com.codejsha.bookstore.service.application.port.pb.categorypb.CategoryFindAllProtoResp>(
                                service, METHODID_FIND_ALL_CATEGORIES)))
                .build();
    }
    ...
    private abstract static class CategoryServiceBaseDescriptorSupplier
        ...
        public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
            return com.codejsha.bookstore.service.application.port.pb.categorypb.CategoryProto.getDescriptor();
        }
    ...
    private static final class CategoryServiceFileDescriptorSupplier extends CategoryServiceBaseDescriptorSupplier {
        CategoryServiceFileDescriptorSupplier() {}
    }

    private static final class CategoryServiceMethodDescriptorSupplier extends CategoryServiceBaseDescriptorSupplier
