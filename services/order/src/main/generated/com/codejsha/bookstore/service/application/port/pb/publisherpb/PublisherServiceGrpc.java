...
public final class PublisherServiceGrpc {
    ...
    @io.grpc.stub.annotations.RpcMethod(
            ...
            requestType = com.codejsha.bookstore.service.application.port.pb.publisherpb.PublisherFindAllProtoReq.class,
            responseType =
                    com.codejsha.bookstore.service.application.port.pb.publisherpb.PublisherFindAllProtoResp.class,
    ...
    public static io.grpc.MethodDescriptor<
        ...
        if ((getFindAllPublishersMethod = PublisherServiceGrpc.getFindAllPublishersMethod) == null) {
            synchronized (PublisherServiceGrpc.class) {
                if ((getFindAllPublishersMethod = PublisherServiceGrpc.getFindAllPublishersMethod) == null) {
                    PublisherServiceGrpc.getFindAllPublishersMethod = getFindAllPublishersMethod = io.grpc
                            .MethodDescriptor
                            .<com.codejsha.bookstore.service.application.port.pb.publisherpb.PublisherFindAllProtoReq,
                            ...
                            .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(com.codejsha.bookstore.service
                                    .application.port.pb.publisherpb.PublisherFindAllProtoReq.getDefaultInstance()))
                            .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(com.codejsha.bookstore.service
                                    .application.port.pb.publisherpb.PublisherFindAllProtoResp.getDefaultInstance()))
                            .setSchemaDescriptor(new PublisherServiceMethodDescriptorSupplier("FindAllPublishers"))
                            .build();
                }
            }
        }
    ...
    @io.grpc.stub.annotations.RpcMethod(
            ...
            requestType = com.codejsha.bookstore.service.application.port.pb.publisherpb.PublisherFindProtoReq.class,
            responseType = com.codejsha.bookstore.service.application.port.pb.publisherpb.PublisherFindProtoResp.class,
            methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
    public static io.grpc.MethodDescriptor<
                    com.codejsha.bookstore.service.application.port.pb.publisherpb.PublisherFindProtoReq,
                    com.codejsha.bookstore.service.application.port.pb.publisherpb.PublisherFindProtoResp>
        ...
        if ((getFindPublisherMethod = PublisherServiceGrpc.getFindPublisherMethod) == null) {
            synchronized (PublisherServiceGrpc.class) {
                if ((getFindPublisherMethod = PublisherServiceGrpc.getFindPublisherMethod) == null) {
                    PublisherServiceGrpc.getFindPublisherMethod = getFindPublisherMethod = io.grpc.MethodDescriptor
                            .<com.codejsha.bookstore.service.application.port.pb.publisherpb.PublisherFindProtoReq,
                                    com.codejsha.bookstore.service.application.port.pb.publisherpb
                            ...
                            .setSampledToLocalTracing(true)
                            .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(com.codejsha.bookstore.service
                                    .application.port.pb.publisherpb.PublisherFindProtoReq.getDefaultInstance()))
                            .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(com.codejsha.bookstore.service
                                    .application.port.pb.publisherpb.PublisherFindProtoResp.getDefaultInstance()))
                            .setSchemaDescriptor(new PublisherServiceMethodDescriptorSupplier("FindPublisher"))
                            .build();
                }
            }
        }
    ...
    public interface AsyncService {
        ...
        default void findAllPublishers(
                com.codejsha.bookstore.service.application.port.pb.publisherpb.PublisherFindAllProtoReq request,
                io.grpc.stub.StreamObserver<
                                com.codejsha.bookstore.service.application.port.pb.publisherpb
                                        .PublisherFindAllProtoResp>
                        responseObserver) {
            io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getFindAllPublishersMethod(), responseObserver);
        }
        ...
        default void findPublisher(
                com.codejsha.bookstore.service.application.port.pb.publisherpb.PublisherFindProtoReq request,
                io.grpc.stub.StreamObserver<
                                com.codejsha.bookstore.service.application.port.pb.publisherpb.PublisherFindProtoResp>
                        responseObserver) {
            io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getFindPublisherMethod(), responseObserver);
        }
    }
     ...
     */
    public abstract static class PublisherServiceImplBase implements io.grpc.BindableService, AsyncService {
    ...
    public static final class PublisherServiceStub extends io.grpc.stub.AbstractAsyncStub<PublisherServiceStub> {
        ...
        public void findAllPublishers(
            ...
            io.grpc.stub.ClientCalls.asyncUnaryCall(
                    getChannel().newCall(getFindAllPublishersMethod(), getCallOptions()), request, responseObserver);
        }
        ...
        public void findPublisher(
                ...
                io.grpc.stub.StreamObserver<
                        ...
                        responseObserver) {
            io.grpc.stub.ClientCalls.asyncUnaryCall(
                    getChannel().newCall(getFindPublisherMethod(), getCallOptions()), request, responseObserver);
        }
    }
    ...
    public static final class PublisherServiceBlockingV2Stub
        ...
        private PublisherServiceBlockingV2Stub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
            super(channel, callOptions);
        }

        @java.lang.Override
        protected PublisherServiceBlockingV2Stub build(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
            return new PublisherServiceBlockingV2Stub(channel, callOptions);
        }
         ...
         *
         */
        public com.codejsha.bookstore.service.application.port.pb.publisherpb.PublisherFindProtoResp findPublisher(
                com.codejsha.bookstore.service.application.port.pb.publisherpb.PublisherFindProtoReq request) {
            return io.grpc.stub.ClientCalls.blockingUnaryCall(
    ...
    public static final class PublisherServiceBlockingStub
        ...
        @java.lang.Override
        protected PublisherServiceBlockingStub build(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
            return new PublisherServiceBlockingStub(channel, callOptions);
        }
    ...
    public static final class PublisherServiceFutureStub
        ...
        @java.lang.Override
        protected PublisherServiceFutureStub build(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
            return new PublisherServiceFutureStub(channel, callOptions);
        }
        ...
        return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
                ...
                .addMethod(
                        ...
                        io.grpc.stub.ServerCalls.asyncUnaryCall(new MethodHandlers<
                                com.codejsha.bookstore.service.application.port.pb.publisherpb.PublisherFindProtoReq,
                                com.codejsha.bookstore.service.application.port.pb.publisherpb.PublisherFindProtoResp>(
                                service, METHODID_FIND_PUBLISHER)))
                .build();
    }
    ...
    private abstract static class PublisherServiceBaseDescriptorSupplier
        ...
        public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
            return com.codejsha.bookstore.service.application.port.pb.publisherpb.PublisherProto.getDescriptor();
        }
    ...
    private static final class PublisherServiceFileDescriptorSupplier extends PublisherServiceBaseDescriptorSupplier {
        PublisherServiceFileDescriptorSupplier() {}
    }

    private static final class PublisherServiceMethodDescriptorSupplier extends PublisherServiceBaseDescriptorSupplier
