...
object TestPersistenceUtils {

    fun mockConnection(provider: MockDataProvider): MockConnection = MockConnection(provider)
    ...
    fun dslContext(jooqConfiguration: Configuration): DSLContext = DSL.using(jooqConfiguration)
