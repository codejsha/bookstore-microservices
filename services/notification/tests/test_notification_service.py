...
class TestSendNotification:
    async def test_persists_pending_notification(
...
class TestGetNotification:
    async def test_returns_when_found(self, service: NotificationService, notification_repo: MagicMock) -> None:
    ...
    async def test_returns_none_when_missing(self, service: NotificationService, notification_repo: MagicMock) -> None:
        notification_repo.find_by_uid.return_value = None
        assert await service.get_notification(uuid4()) is None


class TestListNotifications:
    async def test_delegates_to_repository(self, service: NotificationService, notification_repo: MagicMock) -> None:
...
class TestMarkAsSent:
    ...
    async def test_sets_status_and_sent_at(self, service: NotificationService, notification_repo: MagicMock) -> None:
        notification = make_notification()
        notification_repo.find_by_uid.return_value = notification
...
class TestMarkAsFailed:
    ...
    async def test_sets_failed_status_without_sent_at(
        self, service: NotificationService, notification_repo: MagicMock
    ) -> None:
        notification = make_notification()
        notification_repo.find_by_uid.return_value = notification
...
class TestCreateTemplate:
    async def test_persists_template(self, service: NotificationService, template_repo: MagicMock) -> None:
...
class TestGetTemplate:
    async def test_returns_when_found(self, service: NotificationService, template_repo: MagicMock) -> None:
...
class TestListTemplates:
    async def test_delegates_to_repository(self, service: NotificationService, template_repo: MagicMock) -> None:
...
class TestUpdateTemplate:
    async def test_returns_none_when_missing(self, service: NotificationService, template_repo: MagicMock) -> None:
    ...
    async def test_updates_only_provided_fields(self, service: NotificationService, template_repo: MagicMock) -> None:
        template = make_template()
