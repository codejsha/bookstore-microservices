...
public final class OrderServiceGrpc {
    ...
    public static io.grpc.MethodDescriptor<
        ...
        if ((getFindAllOrdersMethod = OrderServiceGrpc.getFindAllOrdersMethod) == null) {
            synchronized (OrderServiceGrpc.class) {
                if ((getFindAllOrdersMethod = OrderServiceGrpc.getFindAllOrdersMethod) == null) {
                    OrderServiceGrpc.getFindAllOrdersMethod = getFindAllOrdersMethod = io.grpc.MethodDescriptor
                            .<com.codejsha.bookstore.service.application.port.pb.orderpb.OrderFindAllProtoReq,
                                    com.codejsha.bookstore.service.application.port.pb.orderpb.OrderFindAllProtoResp>
                                    newBuilder()
                            ...
                            .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(com.codejsha.bookstore.service
                                    .application.port.pb.orderpb.OrderFindAllProtoReq.getDefaultInstance()))
                            .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(com.codejsha.bookstore.service
                                    .application.port.pb.orderpb.OrderFindAllProtoResp.getDefaultInstance()))
    ...
    public static io.grpc.MethodDescriptor<
        ...
        if ((getFindOrderMethod = OrderServiceGrpc.getFindOrderMethod) == null) {
            synchronized (OrderServiceGrpc.class) {
                if ((getFindOrderMethod = OrderServiceGrpc.getFindOrderMethod) == null) {
                    OrderServiceGrpc.getFindOrderMethod = getFindOrderMethod = io.grpc.MethodDescriptor
                            .<com.codejsha.bookstore.service.application.port.pb.orderpb.OrderFindProtoReq,
                                    com.codejsha.bookstore.service.application.port.pb.orderpb.OrderFindProtoResp>
                                    newBuilder()
                            .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
                            ...
                            .setSampledToLocalTracing(true)
                            .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(com.codejsha.bookstore.service
                                    .application.port.pb.orderpb.OrderFindProtoReq.getDefaultInstance()))
                            .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(com.codejsha.bookstore.service
                                    .application.port.pb.orderpb.OrderFindProtoResp.getDefaultInstance()))
     ...
     */
    public abstract static class OrderServiceImplBase implements io.grpc.BindableService, AsyncService {
    ...
    public static final class OrderServiceBlockingV2Stub
        ...
        @java.lang.Override
        protected OrderServiceBlockingV2Stub build(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
            return new OrderServiceBlockingV2Stub(channel, callOptions);
        }
         ...
         *
         */
        public com.codejsha.bookstore.service.application.port.pb.orderpb.OrderFindAllProtoResp findAllOrders(
                com.codejsha.bookstore.service.application.port.pb.orderpb.OrderFindAllProtoReq request) {
    ...
    public static final class OrderServiceFutureStub extends io.grpc.stub.AbstractFutureStub<OrderServiceFutureStub> {
        ...
        @java.lang.Override
        protected OrderServiceFutureStub build(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
            return new OrderServiceFutureStub(channel, callOptions);
        }
        ...
        public com.google.common.util.concurrent.ListenableFuture<
                        com.codejsha.bookstore.service.application.port.pb.orderpb.OrderFindAllProtoResp>
                findAllOrders(com.codejsha.bookstore.service.application.port.pb.orderpb.OrderFindAllProtoReq request) {
        ...
        public com.google.common.util.concurrent.ListenableFuture<
                        com.codejsha.bookstore.service.application.port.pb.orderpb.OrderFindProtoResp>
                findOrder(com.codejsha.bookstore.service.application.port.pb.orderpb.OrderFindProtoReq request) {
            return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    private static final class OrderServiceFileDescriptorSupplier extends OrderServiceBaseDescriptorSupplier {
        OrderServiceFileDescriptorSupplier() {}
    }

    private static final class OrderServiceMethodDescriptorSupplier extends OrderServiceBaseDescriptorSupplier
