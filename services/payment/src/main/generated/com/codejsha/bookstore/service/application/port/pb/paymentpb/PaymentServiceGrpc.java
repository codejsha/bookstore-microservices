...
public final class PaymentServiceGrpc {
    ...
    public static io.grpc.MethodDescriptor<
        ...
        if ((getFindAllPaymentsMethod = PaymentServiceGrpc.getFindAllPaymentsMethod) == null) {
            synchronized (PaymentServiceGrpc.class) {
                if ((getFindAllPaymentsMethod = PaymentServiceGrpc.getFindAllPaymentsMethod) == null) {
                    PaymentServiceGrpc.getFindAllPaymentsMethod = getFindAllPaymentsMethod = io.grpc.MethodDescriptor
                            .<com.codejsha.bookstore.service.application.port.pb.paymentpb.PaymentFindAllProtoReq,
                            ...
                            .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(com.codejsha.bookstore.service
                                    .application.port.pb.paymentpb.PaymentFindAllProtoReq.getDefaultInstance()))
                            .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(com.codejsha.bookstore.service
                                    .application.port.pb.paymentpb.PaymentFindAllProtoResp.getDefaultInstance()))
    ...
    public static io.grpc.MethodDescriptor<
        ...
        if ((getFindPaymentMethod = PaymentServiceGrpc.getFindPaymentMethod) == null) {
            synchronized (PaymentServiceGrpc.class) {
                if ((getFindPaymentMethod = PaymentServiceGrpc.getFindPaymentMethod) == null) {
                    PaymentServiceGrpc.getFindPaymentMethod = getFindPaymentMethod = io.grpc.MethodDescriptor
                            .<com.codejsha.bookstore.service.application.port.pb.paymentpb.PaymentFindProtoReq,
                                    com.codejsha.bookstore.service.application.port.pb.paymentpb.PaymentFindProtoResp>
                                    newBuilder()
                            .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
                            ...
                            .setSampledToLocalTracing(true)
                            .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(com.codejsha.bookstore.service
                                    .application.port.pb.paymentpb.PaymentFindProtoReq.getDefaultInstance()))
                            .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(com.codejsha.bookstore.service
                                    .application.port.pb.paymentpb.PaymentFindProtoResp.getDefaultInstance()))
     ...
     */
    public abstract static class PaymentServiceImplBase implements io.grpc.BindableService, AsyncService {
    ...
    public static final class PaymentServiceBlockingV2Stub
        ...
        @java.lang.Override
        protected PaymentServiceBlockingV2Stub build(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
            return new PaymentServiceBlockingV2Stub(channel, callOptions);
        }
         ...
         *
         */
        public com.codejsha.bookstore.service.application.port.pb.paymentpb.PaymentFindAllProtoResp findAllPayments(
                com.codejsha.bookstore.service.application.port.pb.paymentpb.PaymentFindAllProtoReq request) {
         ...
         *
         */
        public com.codejsha.bookstore.service.application.port.pb.paymentpb.PaymentFindProtoResp findPayment(
                com.codejsha.bookstore.service.application.port.pb.paymentpb.PaymentFindProtoReq request) {
            return io.grpc.stub.ClientCalls.blockingUnaryCall(
    ...
    public static final class PaymentServiceBlockingStub
        ...
        @java.lang.Override
        protected PaymentServiceBlockingStub build(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
            return new PaymentServiceBlockingStub(channel, callOptions);
        }
    ...
    public static final class PaymentServiceFutureStub
        ...
        @java.lang.Override
        protected PaymentServiceFutureStub build(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
            return new PaymentServiceFutureStub(channel, callOptions);
        }
        ...
        public com.google.common.util.concurrent.ListenableFuture<
                        com.codejsha.bookstore.service.application.port.pb.paymentpb.PaymentFindProtoResp>
                findPayment(com.codejsha.bookstore.service.application.port.pb.paymentpb.PaymentFindProtoReq request) {
            return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    private static final class PaymentServiceFileDescriptorSupplier extends PaymentServiceBaseDescriptorSupplier {
        PaymentServiceFileDescriptorSupplier() {}
    }

    private static final class PaymentServiceMethodDescriptorSupplier extends PaymentServiceBaseDescriptorSupplier
