...
public final class PaymentServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.codejsha.bookstore.service.application.port.pb.paymentpb.PaymentFindAllProtoReq,
      com.codejsha.bookstore.service.application.port.pb.paymentpb.PaymentFindAllProtoResp> getFindAllPaymentsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "FindAllPayments",
      requestType = com.codejsha.bookstore.service.application.port.pb.paymentpb.PaymentFindAllProtoReq.class,
      responseType = com.codejsha.bookstore.service.application.port.pb.paymentpb.PaymentFindAllProtoResp.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.codejsha.bookstore.service.application.port.pb.paymentpb.PaymentFindAllProtoReq,
      com.codejsha.bookstore.service.application.port.pb.paymentpb.PaymentFindAllProtoResp> getFindAllPaymentsMethod() {
    io.grpc.MethodDescriptor<com.codejsha.bookstore.service.application.port.pb.paymentpb.PaymentFindAllProtoReq, com.codejsha.bookstore.service.application.port.pb.paymentpb.PaymentFindAllProtoResp> getFindAllPaymentsMethod;
    if ((getFindAllPaymentsMethod = PaymentServiceGrpc.getFindAllPaymentsMethod) == null) {
      synchronized (PaymentServiceGrpc.class) {
        if ((getFindAllPaymentsMethod = PaymentServiceGrpc.getFindAllPaymentsMethod) == null) {
          PaymentServiceGrpc.getFindAllPaymentsMethod = getFindAllPaymentsMethod =
              io.grpc.MethodDescriptor.<com.codejsha.bookstore.service.application.port.pb.paymentpb.PaymentFindAllProtoReq, com.codejsha.bookstore.service.application.port.pb.paymentpb.PaymentFindAllProtoResp>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "FindAllPayments"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.codejsha.bookstore.service.application.port.pb.paymentpb.PaymentFindAllProtoReq.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.codejsha.bookstore.service.application.port.pb.paymentpb.PaymentFindAllProtoResp.getDefaultInstance()))
              .setSchemaDescriptor(new PaymentServiceMethodDescriptorSupplier("FindAllPayments"))
              .build();
        }
      }
    }
  ...
  private static volatile io.grpc.MethodDescriptor<com.codejsha.bookstore.service.application.port.pb.paymentpb.PaymentFindProtoReq,
      com.codejsha.bookstore.service.application.port.pb.paymentpb.PaymentFindProtoResp> getFindPaymentMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "FindPayment",
      requestType = com.codejsha.bookstore.service.application.port.pb.paymentpb.PaymentFindProtoReq.class,
      responseType = com.codejsha.bookstore.service.application.port.pb.paymentpb.PaymentFindProtoResp.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.codejsha.bookstore.service.application.port.pb.paymentpb.PaymentFindProtoReq,
      com.codejsha.bookstore.service.application.port.pb.paymentpb.PaymentFindProtoResp> getFindPaymentMethod() {
    io.grpc.MethodDescriptor<com.codejsha.bookstore.service.application.port.pb.paymentpb.PaymentFindProtoReq, com.codejsha.bookstore.service.application.port.pb.paymentpb.PaymentFindProtoResp> getFindPaymentMethod;
      ...
      synchronized (PaymentServiceGrpc.class) {
        if ((getFindPaymentMethod = PaymentServiceGrpc.getFindPaymentMethod) == null) {
          PaymentServiceGrpc.getFindPaymentMethod = getFindPaymentMethod =
              io.grpc.MethodDescriptor.<com.codejsha.bookstore.service.application.port.pb.paymentpb.PaymentFindProtoReq, com.codejsha.bookstore.service.application.port.pb.paymentpb.PaymentFindProtoResp>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "FindPayment"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.codejsha.bookstore.service.application.port.pb.paymentpb.PaymentFindProtoReq.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.codejsha.bookstore.service.application.port.pb.paymentpb.PaymentFindProtoResp.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void findAllPayments(com.codejsha.bookstore.service.application.port.pb.paymentpb.PaymentFindAllProtoReq request,
        io.grpc.stub.StreamObserver<com.codejsha.bookstore.service.application.port.pb.paymentpb.PaymentFindAllProtoResp> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getFindAllPaymentsMethod(), responseObserver);
    }

    /**
     */
    default void findPayment(com.codejsha.bookstore.service.application.port.pb.paymentpb.PaymentFindProtoReq request,
        io.grpc.stub.StreamObserver<com.codejsha.bookstore.service.application.port.pb.paymentpb.PaymentFindProtoResp> responseObserver) {
  ...
  public static final class PaymentServiceStub
    ...
    /**
     */
    public void findAllPayments(com.codejsha.bookstore.service.application.port.pb.paymentpb.PaymentFindAllProtoReq request,
        io.grpc.stub.StreamObserver<com.codejsha.bookstore.service.application.port.pb.paymentpb.PaymentFindAllProtoResp> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getFindAllPaymentsMethod(), getCallOptions()), request, responseObserver);
    }

    /**
     */
    public void findPayment(com.codejsha.bookstore.service.application.port.pb.paymentpb.PaymentFindProtoReq request,
        io.grpc.stub.StreamObserver<com.codejsha.bookstore.service.application.port.pb.paymentpb.PaymentFindProtoResp> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
  ...
  public static final class PaymentServiceBlockingV2Stub
    ...
    /**
     */
    public com.codejsha.bookstore.service.application.port.pb.paymentpb.PaymentFindAllProtoResp findAllPayments(com.codejsha.bookstore.service.application.port.pb.paymentpb.PaymentFindAllProtoReq request) {
    ...
    /**
     */
    public com.codejsha.bookstore.service.application.port.pb.paymentpb.PaymentFindProtoResp findPayment(com.codejsha.bookstore.service.application.port.pb.paymentpb.PaymentFindProtoReq request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class PaymentServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.codejsha.bookstore.service.application.port.pb.paymentpb.PaymentFindAllProtoResp> findAllPayments(
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.codejsha.bookstore.service.application.port.pb.paymentpb.PaymentFindProtoResp> findPayment(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_FIND_ALL_PAYMENTS:
          serviceImpl.findAllPayments((com.codejsha.bookstore.service.application.port.pb.paymentpb.PaymentFindAllProtoReq) request,
              (io.grpc.stub.StreamObserver<com.codejsha.bookstore.service.application.port.pb.paymentpb.PaymentFindAllProtoResp>) responseObserver);
          break;
        case METHODID_FIND_PAYMENT:
          serviceImpl.findPayment((com.codejsha.bookstore.service.application.port.pb.paymentpb.PaymentFindProtoReq) request,
              (io.grpc.stub.StreamObserver<com.codejsha.bookstore.service.application.port.pb.paymentpb.PaymentFindProtoResp>) responseObserver);
          break;
        default:
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              ...
              com.codejsha.bookstore.service.application.port.pb.paymentpb.PaymentFindAllProtoResp>(
                service, METHODID_FIND_ALL_PAYMENTS)))
        .addMethod(
  ...
  private static abstract class PaymentServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.codejsha.bookstore.service.application.port.pb.paymentpb.PaymentProto.getDescriptor();
    }
