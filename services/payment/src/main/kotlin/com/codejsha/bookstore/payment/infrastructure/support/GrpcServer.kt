...
import com.codejsha.bookstore.payment.infrastructure.support.auth.ActorIdentityServerInterceptor
...
class GrpcServer(
    ...
    private val actorIdentityInterceptor: ActorIdentityServerInterceptor,
    ...
    override fun start() {
        ...
        val s =
            ServerBuilder
                ...
                .addService(
                    ServerInterceptors.intercept(paymentGrpcServer, actorIdentityInterceptor, grpcMetricsInterceptor),
                )
